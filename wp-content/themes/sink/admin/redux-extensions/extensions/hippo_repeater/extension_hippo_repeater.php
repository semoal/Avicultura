<?php
	...
	// Don't duplicate me!
	if ( ! class_exists( 'ReduxFramework_extension_hippo_repeater' ) ) :


		/**
		 * Main ReduxFramework_extension_hippo_repeater extension class
		 *
		 * @since       3.1.6
		 */
		class ReduxFramework_extension_hippo_repeater extends ReduxFramework {
			...
			public function __construct( $parent ) {
				...
				$this->parent     = $parent;
				$this->field_name = 'hippo_repeater';

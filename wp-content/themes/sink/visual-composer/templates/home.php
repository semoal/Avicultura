<?php
	...
	add_filter( 'vc_load_default_templates', 'hippo_vc_template_home' );
	function hippo_vc_template_home( $data ) {

		$template                   = array();
		$template[ 'name' ]         = esc_html__( 'Home', 'sink' );
		$template[ 'image_path' ]   = get_template_directory_uri() . '/visual-composer/assets/images/thumbs/home.png'; // always use preg replace to be sure that "space" will not break logic
		$template[ 'custom_class' ] = 'hippo_vc_template_home';

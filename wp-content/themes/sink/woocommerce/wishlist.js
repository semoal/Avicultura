jQuery( document ).ready( function( $ ){
    ...
    function init_handling_after_ajax(){
        ...
        $(document.body).trigger('init-wishlist');
    ...
    function call_ajax_add_to_wishlist( el ) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            beforeSend: function(){
                el.removeClass('adding-to-wishlist added-to-wishlist')
                .addClass('adding-to-wishlist');

                el.siblings( '.ajax-loading' ).css( 'visibility', 'visible' );

                $(document.body).trigger('before-adding-to-wishlist', [el]);
            },
            complete: function(){
                el.removeClass('adding-to-wishlist added-to-wishlist')
                ...
                $(document.body).trigger('complete-adding-to-wishlist', [el]);
            },
            success: function( response ) {
                ...
                $(document.body).trigger('added-to-wishlist', [el, response]);
            }
    ...
    function remove_item_from_wishlist( el ) {
        ...
        $( '#yith-wcwl-form' ).load( yith_wcwl_l10n.ajax_url + ' #yith-wcwl-form', data, function(){
            ...
            $(document.body).trigger('removed-from-wishlist', [el, data]);
        } );
    }

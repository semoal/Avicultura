							...
							if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
								...
								switch ( $column_id ) {
									case 'download-product' : ?>
										...
										<?php break;
									case 'download-file' : ?>
									<!-- Debemos ir a pdf-viewer y desde alli comprobar al 100% que es ese usuario el que intenta acceder
									    Comprobar el EXPIRES Y la cantidad de descargas restantes -->
									<!-- 
									    Pasarle algun parametro para saber la ruta del archivo pero que sea oculto para el usuario 
									-->
									<!--
										...
										<a href="<?php echo '/pdf-viewer?product_id='.$download['product_id'].'&order='.$download['order_key'].'&key='.$download['download_id']; ?> " class="woocommerce-MyAccount-downloads-file">
										<?php 
										echo esc_html($download['file']['name']);
										?>
										</a>
											<!-- dominio + /pdf-viewer?download_file=93&order=wc_order_59988130b2e3d&email=sergiomorenoalbert%40gmail.com&key=fab67778121cbc3ef17757bdb066349-->
										<?php break;
